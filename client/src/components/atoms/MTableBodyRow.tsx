...
console.log(this.props.dragHandleProps);
    return (
      <TableCell
        size={size}
        padding="none"
        key="key-selection-column"
        style={{ width: selectionWidth, position: "relative" }}
      >
        {/* <Stack direction="row" spacing={1} alignItems="center"> */}
          ...
          {this.props.dragHandleProps && (
            <div style={{ position: "absolute", top: "50%", right: "-20px", transform: "translateY(-40%)"}} {...this.props.dragHandleProps}>
              <DragIndicator />
            </div>
          )}
        {/* </Stack> */}
