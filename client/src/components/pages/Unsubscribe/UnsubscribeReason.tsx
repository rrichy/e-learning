    ...
    <Stack justifyContent="space-between">
      <Paper variant="outlined">
        ...
        <Stack alignItems="center" p={3}>
          ...
          <Typography>今後のサビーズ改善のため、退会する理由を聞かせください。</Typography>
        </Stack>
        <FormContainer>
          <Stack p={5}>
            <TextField
        ...
        <Dialog open={open} maxWidth="xl">
          ...
          <DialogContent>
            ...
            <Stack p={3}>
              <Typography>退会するとご登録されているアカウントに関する全ての情報が削除されます。</Typography>
              <Typography>※ 30日以内であればアカウントへのログインが可能です。</Typography>
            </Stack>
            <Stack p={3}>
