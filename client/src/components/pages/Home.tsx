...
function Home() {
  ...
  if (membershipTypeId === MembershipType.individual)
    return <StudentHomepage />;

  return (
    <div>
      Home Page (Sidebar) <br />
      <br />
      ADMIN Links <br />
      <Link to="/course-management">Course Management - コース管理</Link> <br />
      <Link to="/account-management">Account - アカウント管理</Link> <br />
      <Link to="/affiliations-departments-management">
        Affiliations Departments - 所属・部署管理
      </Link>{" "}
      <br />
      ...
      <Link to="/organize-mail-management">
        Organize Mail - メールテンプレート管理
      </Link>{" "}
      <br />
      ...
      <Link to="/send-inquiry">Contact - お問い合わせ</Link> <br />
      <Link to="/unsubscribe">Unsubscribe</Link> <br />
      <br />
    </div>
  );
}
