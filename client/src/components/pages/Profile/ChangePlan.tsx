          ...
          <Stack spacing={1}>
              ...
              >
                <Stack direction="row" justifyContent="space-between" pb={2}>
                  <Typography variant="h5" fontWeight={700}>
                    <span style={{ color: "#00c2b2" }}>1ヶ月</span>プラン
                  </Typography>
                ...
                <Divider />
                <Typography pt={2} fontSize={13}>
                  プランの説明文が入ります。プランの説明文が入ります。プランの説明文が入ります。プランの説明文が入ります。プランの説明文が入ります。
                </Typography>
              </Paper>
              <Button
                type="button"
            ...
            <Stack pt={3} direction="row" m={{ xs: 2, md: 4 }}>
              ...
              >
                <Stack direction="row" justifyContent="space-between" pb={2}>
                  <Typography variant="h5" fontWeight={700}>
                    <span style={{ color: "#00c2b2" }}>3ヶ月</span>プラン
                  </Typography>
                  <Stack alignItems="flex-end" spacing={1}>
                    ...
                    <Typography fontSize={13}>
                      ※お支払いは、3ヶ月分の20,700円（税込）一括払いとなります。
                    </Typography>
                  </Stack>
                </Stack>
                <Divider />
            ...
            <Stack pt={3} direction="row" m={{ xs: 2, md: 4 }}>
              ...
              >
                <Stack direction="row" justifyContent="space-between" pb={2}>
                  <Typography variant="h5" fontWeight={700}>
                    <span style={{ color: "#00c2b2" }}>6ヶ月</span>プラン
                  </Typography>
                  <Stack alignItems="flex-end" spacing={1}>
                    <Stack direction="row" alignItems="flex-end">
                      <Typography variant="h5" fontWeight={700}>
                    ...
                    <Typography fontSize={13}>
                      ※お支払いは、3ヶ月分の29,400円（税込）一括払いとなります。
                    </Typography>
                  </Stack>
                </Stack>
                <Divider />
