  ...
  return (
    <Stack spacing={3} direction={{ xs: "column", lg: "row"}}>
      ...
      <Stack spacing={3} flex={1}>
        ...
        <Paper variant="softoutline" sx={{ p: 7 }}>
          <Stack spacing={1}>
            <Typography variant="sectiontitle2">オプションのお申込み</Typography>
            ...
            <Stack pt={3} direction="row" m={{ xs: 2, md: 4 }}>
              ...
              >
                <Stack direction="row" justifyContent="space-between" pb={2}>
                  <Typography variant="h5" fontWeight={700}>個別学習サポート <Chip label="ご利用中" color="secondary" /></Typography>
                  <Typography variant="h5" fontWeight={700}>￥xx,xxx</Typography>
                </Stack>
                <Divider />
                <Stack direction="row" justifyContent="space-between" pt={2}>
                  <Typography>✔ サポート内容<br />✔ サポート内容<br />✔ サポート内容<br /></Typography>
            ...
            <Stack pt={3} direction="row" m={{ xs: 2, md: 4 }}>
              ...
              >
                <Stack direction="row" justifyContent="space-between" pb={2}>
                  <Typography variant="h5" fontWeight={700}>個別学習サポート</Typography>
                  <Typography variant="h5" fontWeight={700}>￥xx,xxx</Typography>
                </Stack>
                <Divider />
                <Stack direction="row" justifyContent="space-between" pt={2}>
            ...
            <Stack pt={3} direction="row" m={{ xs: 2, md: 4 }}>
              ...
              >
                ...
                <Divider />
                <Stack direction="row" justifyContent="space-between" pt={2}>
                  <Typography>プランの説明文が入ります。プランの説明文が入ります。</Typography>
                  <Typography>￥xxx / 月</Typography>
                </Stack>
              </Paper>
            </Stack>
