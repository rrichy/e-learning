...
function CommonProfile({
  ...
  return (
    <Paper
      variant="softoutline"
      sx={{ p: 5, minWidth: 255, height: "fit-content" }}
    >
      ...
      <Stack spacing={2} pt={3}>
        <Button variant="contained" type="button" rounded to="/profile">
          アカウント編集
        </Button>
        <Button variant="contained" type="button" rounded to="/my-page/plan">
          プラン変更
        </Button>
        <Button
          variant="contained"
